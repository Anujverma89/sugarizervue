...
const Password ={
	template: `<div class="password-class">
					...
					<div class="password-line">
						<div class="password-label">Your images:</div>
						<div class="password-input">
							...
							<div v-if="showCancel"
								...
								:class="{'form-focus':isNull}"
							></div>
						</div>
						<div>
							<div class="password-emojis" v-if="currentEmojis.length==10">
								<div class="emojiset1">
									<div class="emoji" v-for='index in 5' :key='index' v-on:click="emojiClicked($event, index-1)">
	...
	watch: {
		...
		passwordText:function(value,prev){
			if(value != prev){
				this.isError=false;
			}
		},
		sendPassword:function(now,prev){
	...
	mounted(){
		for(i=0 ; i<10; i++){
			this.currentEmojis[i]=this.emojisData[i];
			// console.log(this.emojisData[i]);
		}
	}
}